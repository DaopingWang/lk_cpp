...
//        aim_pub.publish(msg);int hockeyNum = 0;
    ...
    bool pg_info_callback(main_state_machine::pg_info_transfer::Request &req,
                          main_state_machine::pg_info_transfer::Response &res){
        int color = req.color; //0:blue   1:yellow
        return true;
    }
    ...
    void imagecallback(const sensor_msgs::ImageConstPtr& image)
    {
     ...
     //   tf::TransformListener listener_;
        ...
        if(keypoint/area>0.5){
            ...
            //cout<<"sadasdasdasd"<<keypoint/area<<endl;
        }
...
//                        }
                    ...
                    if(abs(r.tl().x + 0.5*r.width-0.5*columns)>30 && !isForward)
                    {
