...
bool measure(std_srvs::Empty::Request &req1,std_srvs::Empty::Response &res1){
...
int main(int argc, char **argv){
    ...
    ros::ServiceServer service = nh.advertiseService("start_measure_ab",measure);
    client = nh.serviceClient<main_state_machine::pg_info_transfer>("ab_ident_finished");
