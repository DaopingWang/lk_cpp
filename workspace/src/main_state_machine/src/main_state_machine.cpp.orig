...
bool driver_togoal_finished_callback(std_srvs::Empty::Request& request,
    ...
    if (sm.num_goal == 3) {
        ...
        color_seg_client.call(empty_srv);
...
<<<<<<< HEAD
<<<<<<< HEAD
    goal_location_srv.request.a = 2.5;
    goal_location_srv.request.b = 0;
    goal_location_srv.request.c = 0;

=======
    goal_location_srv.request.a = 2;
    goal_location_srv.request.b = -1;
    goal_location_srv.request.c = 0;

=======
>>>>>>> 5eca01b11e11311cfa365f54bdd64a804ed180c7
    switch (sm.num_goal) {
    case 0:
        goal_location_srv.request.b = 0;
        break;
...
>>>>>>> 3e33f1163653358879b9a5d0f0faac28111b256e
...
int main(int argc, char **argv)	{
    ...
    color_seg_client = nh.serviceClient<std_srvs::Empty>("start_to_color");
